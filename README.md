...
**4. Consultas al RAG por llamada** — **0.16 de media**, máximo 1. Son bajas a propósito:
...
Más `make test`: **567 tests**, que incluyen cero falsos positivos de manipulación sobre
...
```bash
make test        # 567 tests unitarios y de regresión
